...
import top.stx.train.business.domain.TrainCarriageExample;
import top.stx.train.business.mapper.TrainCarriageMapper;
...
public class TrainCarriageService {
    ...
    private TrainCarriage selectByUnique(String trainCode, Integer index) {
        ...
        trainCarriageExample.createCriteria()
            .andTrainCodeEqualTo(trainCode).andIndexEqualTo(index);
