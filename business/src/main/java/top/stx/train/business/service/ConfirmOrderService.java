...
import top.stx.train.business.domain.ConfirmOrderExample;
import top.stx.train.business.domain.DailyTrainCarriage;
import top.stx.train.business.domain.DailyTrainSeat;
import top.stx.train.business.domain.DailyTrainTicket;
import top.stx.train.business.enums.ConfirmOrderStatusEnum;
import top.stx.train.business.enums.SeatColEnum;
import top.stx.train.business.enums.SeatTypeEnum;
import top.stx.train.business.mapper.ConfirmOrderMapper;
import top.stx.train.business.req.ConfirmOrderDoReq;
import top.stx.train.business.req.ConfirmOrderQueryReq;
import top.stx.train.business.req.ConfirmOrderTicketReq;
import top.stx.train.business.resp.ConfirmOrderQueryResp;
...
public class ConfirmOrderService {
    ...
    private void getSeat(List<DailyTrainSeat> finalSeatList, Date date, String trainCode, String seatType,
        ...
        for (DailyTrainCarriage dailyTrainCarriage : carriageList) {
            ...
            List<DailyTrainSeat> seatList = dailyTrainSeatService.selectByCarriage(date, trainCode,
    ...
    private boolean calSell(DailyTrainSeat dailyTrainSeat, Integer startIndex, Integer endIndex) {
        ...
        if (Integer.parseInt(sellPart) > 0) {
            ...
            LOG.info("座位{}在本次车站区间{}~{}未售过票，可选中该座位", dailyTrainSeat.getCarriageSeatIndex(),
                startIndex, endIndex);
            //  111,   111
