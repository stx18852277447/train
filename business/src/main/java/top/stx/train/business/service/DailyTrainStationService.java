...
import top.stx.train.business.domain.DailyTrainStation;
import top.stx.train.business.domain.DailyTrainStationExample;
import top.stx.train.business.mapper.DailyTrainStationMapper;
...
public class DailyTrainStationService {
    ...
    public PageResp<DailyTrainStationQueryResp> queryList(DailyTrainStationQueryReq req) {
        ...
        List<DailyTrainStation> dailyTrainStationList = dailyTrainStationMapper.selectByExample(
