...
import top.stx.train.business.domain.DailyTrainCarriageExample;
import top.stx.train.business.mapper.DailyTrainCarriageMapper;
import top.stx.train.business.req.DailyTrainCarriageQueryReq;
import top.stx.train.business.req.DailyTrainCarriageSaveReq;
import top.stx.train.business.resp.DailyTrainCarriageQueryResp;
...
public class DailyTrainCarriageService {
    ...
    public PageResp<DailyTrainCarriageQueryResp> queryList(DailyTrainCarriageQueryReq req) {
        ...
        List<DailyTrainCarriage> dailyTrainCarriageList = dailyTrainCarriageMapper.selectByExample(
            dailyTrainCarriageExample);
